...
Exécuter les gates de `.github/workflows/ci.yml`, appliquer la migration sur un projet de préproduction, tester connexion/OTP/OAuth, upload/download sur deux appareils, Checkout/portail Stripe, achat/restauration RevenueCat, notifications push/e-mail avec reçus et bounces, consentement analytics sur les trois surfaces, renouvellement/annulation des webhooks et suppression de compte avec une connexion récente.
