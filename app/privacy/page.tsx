...
export default function PrivacyPage() {
  return (
    <main className="mx-auto max-w-3xl px-5 py-14 text-sm leading-7 text-ink-2">
      ...
      <p className="mt-4">Vous pouvez exporter vos données locales, désactiver les notifications ou supprimer votre compte depuis Réglages &gt; Compte. La suppression efface les données serveur associées. Les journaux techniques limités nécessaires à la sécurité et à la fiabilité sont conservés séparément.</p>
