...
describe("RevenueCat billing state", () => {
  it("maps active App Store subscriptions", () => {
    expect(parseRevenueCatBillingState({ subscriber: {
      entitlements: { pro: { expires_date: "2026-08-14T12:00:00.000Z", product_identifier: "wariba.pro.monthly" } },
      subscriptions: { "wariba.pro.monthly": { expires_date: "2026-08-14T12:00:00.000Z", period_type: "NORMAL", store: "app_store", unsubscribe_detected_at: null } },
  ...
  it("fails closed for expired subscriptions", () => {
    expect(parseRevenueCatBillingState({ subscriber: {
      entitlements: { pro: { expires_date: "2026-06-14T12:00:00.000Z", product_identifier: "wariba.pro.monthly" } },
      subscriptions: { "wariba.pro.monthly": { expires_date: "2026-06-14T12:00:00.000Z", store: "play_store" } },
